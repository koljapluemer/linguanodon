<template>
  <div class="space-y-6">
    <div v-if="goal">
      <DoTaskWidget
        :title="goal.coreTasks.find(t => t.taskType === 'add-examples-to-goal')?.title || 'Add Examples'"
        :prompt="goal.coreTasks.find(t => t.taskType === 'add-examples-to-goal')?.prompt || 'Add example sentences or phrases related to this goal'"
        @completed="handleTaskCompleted"
        @skipped="handleTaskCompleted"
      />
      
      <div class="divider">Work on Examples</div>

 ...
 * @property {number} recordStreakBaseline
 * @property {number} tasksCompleted
 * @property {number} timePlayedMs
 */

/**
 * @typedef {object} StatsTracker
 * @property {() => PlayerStats} breakStreak
 * @property {() => void} destroy
 * @property {() => PlayerStats} getStats
 * @property {(wasPerfectRound: boolean) => PlayerStats} recordCompletedTask
 * @property {(listener: (stats: PlayerStats) => void) => (() => void)} subscribe
 */
...
export function createStatsTracker() {
  /** @type {Set<(stats: PlayerStats) => void>} */
...
/**
 * @param {number} timePlayedMs
 */
export function formatPlayedTime(timePlayedMs) {

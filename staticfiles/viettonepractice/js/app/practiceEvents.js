 ...
 */
export const appendPracticeEvent = (event) => addEvent(event);
...
const parsePracticeEvent = (value) => {
  ...
  return {
    ...
    correctTone: readOptionalNullableStringLiteral(value.correctTone, TONE_KEYS, "correctTone"),
    distractorTone: readOptionalNullableStringLiteral(value.distractorTone, TONE_KEYS, "distractorTone"),
  };
};

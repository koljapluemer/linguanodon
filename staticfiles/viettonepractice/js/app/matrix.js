...
// Vanilla-DOM port of PracticeStatsMatrix.vue - tone-only, so the `kind`
// prop from the source component is dropped (there is only ever one
// matrix). Deliberately keeps the source's quirk of recomputing
